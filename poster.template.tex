...
\setbeamertemplate{background}{
  \begin{tikzpicture}[remember picture,overlay]
    \node at (current page.center)
      {\includesvg[height=\paperheight, keepaspectratio=false]{images/NumPEx_1.svg}};
...
% In your preamble, after loading beamer:
\usepackage{xcolor} % For color manipulation

% Define a nice purple or pink with partial transparency
% The color is tinted purple with 30% opacity over white
\definecolor{BlockTitleBG}{HTML}{8E44AD}  % Or any color you like

% A softer purple background for the block title, black text
\setbeamercolor{block title}{
  use=normal text,
  bg=purple!15!white,  % 15% purple + 85% white
  fg=black
}
% Similarly, for the block body, you can keep white or give it a slight tint
